							...
							<ul>
								<li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
									<div class="contact-address">
										...
										<span class="text-white">88 Accra Street, East Legon</span> <br>
										<span class="text-white">88 Accra Street, East Legon</span>
									</div>
								</li>
								<li class="d-flex mb-4"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>
									<div class="contact-address">
										<h5 class="text-white">Call Us</h5>
										<span class="d-table text-white">+233 541-421-062</span>
										<span class="text-white">+233 541-421-062 </span>
									</div>
								</li>
								<li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
									<div class="contact-address">
										<h5 class="text-white">Email Adderss</h5>
										<span class="d-table text-white">sales@realestatest.com</span>
										<span class="text-white">sales@realestatest.com</span>
									</div>
								</li>
							</ul>
						</div>
